...
variable "openvpn_route_table_id" {
  description = "Gets the id of the route table used in openvpn vpc"
}

variable "testing_route_table_id" {
  description = "Gets the id of the routing table used in customer vpc"
}
